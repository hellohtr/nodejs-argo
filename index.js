...
const UUID = process.env.UUID || '106232a4-04d9-41e4-a864-e62335993367'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nezha.eli05021212.dpdns.org:9527';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || 'tuosdJ2P7spm94TrYDS5qBpSe8zKUlMh';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
